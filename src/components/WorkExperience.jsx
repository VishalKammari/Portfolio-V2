...
// const experiences = [ { company: "Infosys Springboard", role: "Software Developer Intern", duration: "Aug 2025 – Oct 2025", description: "Built full-stack features for Campus Event Hub using Node.js and MongoDB. Designed UI wireframes in Figma and developed RESTful APIs for event registration.", logo: infosys, }, { company: "Swecha", role: "Frontend Developer Intern", duration: "Jan 2025 – Apr 2025", description: "Developed and maintained responsive frontend interfaces using React and TailwindCSS. Integrated REST APIs and improved application performance across devices.", logo: Swecha, }, { company: "Freelance Developer", role: "Self Employed", duration: "Jun 2024 – Present", description: "Designed and developed full-stack web applications using React, Node.js, Express, and MongoDB. Improved client website performance and responsiveness.", logo: Stealth, }, ];
...
//                 src={exp.logo}
//                 alt={exp.company}
//                 className="w-14 h-14 rounded-xl border border-black/10 object-cover"
//               />
//             </motion.div>
...
//                   <p className="text-gray-600 text-lg">{exp.role}</p>
//                 </div>
